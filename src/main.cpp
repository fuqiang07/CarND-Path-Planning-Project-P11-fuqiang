...
/*
 * **************************************************************** *
 *        Define my helper functions here: General Functions
 * **************************************************************** *
*/
double mph2ms(double vel_mph) { return vel_mph * 1609.00 / 3600.00; }
double ms2mph(double vel_ms) { return vel_ms * 3600.00 / 1609.00; }

unsigned int getLaneID(double car_d)
{
    unsigned int uLaneId = 0;

    if ((car_d >= 0.0) and (car_d < LANE_WIDTH) )
    {
        uLaneId = 1;
    }
    else if ((car_d >= LANE_WIDTH) and (car_d < LANE_WIDTH * 2) )
    {
        uLaneId = 2;
    }
    else if ((car_d >= LANE_WIDTH * 2) and (car_d < LANE_WIDTH * 3) )
    {
        uLaneId = 3;
    }
...
/*
 * **************************************************************** *
 *        Define my helper functions here: Prediction
 * **************************************************************** *
*/

/*
 * **************************************************************** *
 *        Define my helper functions here: Behavior Planning
 * **************************************************************** *
*/
...
/*
 * **************************************************************** *
 *        Define my helper functions here: Trajectory Generation
 * **************************************************************** *
*/
...
/*
 * **************************************************************** *
 *        Define my helper functions here: Cost Ranking
 * **************************************************************** *
*/
